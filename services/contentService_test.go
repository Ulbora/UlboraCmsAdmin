...
func TestContentService_getToken(t *testing.T) {
	if testToken == "" {
...
func TestContentService_GetContentListCategory(t *testing.T) {
	var c ContentService
	c.Host = "http://localhost:3008"
	_, res := c.GetContentListCategory("403", "music2")
...
func TestContentService_decodeB64String(t *testing.T) {
	var b64str = ""
	var rtn = decodeB64String(b64str)
	fmt.Print("rtn decoded: ")
	fmt.Println(rtn)
	if rtn != "" {
		t.Fail()
	}
...
func TestContentService_decodeB64String2(t *testing.T) {
	var b64str = "f"
	var rtn = decodeB64String(b64str)
	fmt.Print("rtn decoded: ")
	fmt.Println(rtn)
